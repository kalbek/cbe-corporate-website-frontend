...
const data = [
  {
    title:
      "የኢትዮጵያ ንግድ ባንክ ሰሞኑን በውስጥ ሲስተም ችግር ምክንያት ያጋጠመውን የአገልግሎት መስተጓጎል በማስመልከት የተዘጋጀ ጋዜጣዊ መግለጫ ::",
    size: "3345.33 KB",
    date: "2024-03-18",
    download: "Press release (2).pdf",
  },
  {
    title: "EthioDirect",
    size: "104.06 KB",
    date: "2023-02-28",
    download: "Ethio Direct.pdf",
  },
  {
    title:
      "የታላቁ ህዳሴ ግድብ ሐብት ማሰባሰብ የህዝብ ድጋፍን አጠናክሮ የማስቀጠል እንቅስቃሴን በተመለከተ የተሰጠ ጋዜጣዊ መግለጫ",
    size: "163.18 KB",
    date: "2023-02-24",
    download: "Press Release on GERD -2014.pdf",
  },
  {
    title: "2020-21 FY Annual Performance",
    size: "437.47 KB",
    date: "2022-08-23",
    download: "ጋዜጣዊ መግለጫ 2013 ዓ.ም.pdf",
  },
  {
    title: "Press Release on IDFR",
    size: "164.6 KB",
    date: "2021-07-09",
    download: "Press Release on IDFR.pdf",
  },
  {
    title: "2016-17 Annual Performance",
    size: "213.9 KB",
    date: "2021-06-15",
    download: "Press-release-2016-17-Annual.pdf",
  },
  {
    title: "2018-19 First Quarter Performance",
    size: "136.34 KB",
    date: "2021-05-08",
    download: "2018-19-10.pdf",
  },
  {
    title: "2020-21 Second Quarter Performance",
    size: "97.74 KB",
    date: "2021-05-08",
    download: "2nd-quarter-2020-21.pdf",
  },
  {
    title:
      "CBE launches first international mobile money transfer service to Ethiopia via CBE Birr",
    size: "190.64 KB",
    date: "2021-05-08",
    download: "WorldRemit-and-CBE-Joint-Press-Release-January-2019.pdf",
  },
];
    ...
    <div className="font-primary">
      ...
      <section className="container mx-auto px-4 grid grid-cols-2 gap-10 py-15">
        <div className="col-span-2  ">
          ...
          <h2 className="text-[18px] font-semibold py-5">Press Release</h2>
