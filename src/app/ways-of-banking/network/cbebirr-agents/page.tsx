...
const columns = [
  ...
  { id: 'telephone', header: 'Telephone', accessorKey: 'telephone' },
  {
    ...
    header: 'Responsible Branch',
    accessorKey: 'responsibleBranch',
  },
  { id: 'location', header: 'Location', accessorKey: 'location' },
  {
    id: 'agentBusiness',
    header: 'Agent Business',
    accessorKey: 'agentBusiness',
  },
]
          ...
          <div className="w-1/2 flex items-center justify-center">
            <div className="max-w-2xl px-8 py-6">
              ...
              <p className="max-w-2xl text-base mb-4 text-white !text-white">
                From city centers to rural communities, our branches bring
      ...
      <div className="container mx-auto px-4 py-2">
              ...
              <div className="flex gap-2">
                <button
                  className={`px-4 py-2 rounded-sm border-[--color-puple-800] text-black font-medium ${
                    activeTab === 'Branch Network' ? 'bg-[#892890]' : 'bg-white'
                  }`}
                ...
                <button
                  className={`px-4 py-2 rounded-sm border-[--color-puple-800] text-black font-medium ${
                    activeTab === 'POS' ? 'bg-[#892890]' : 'bg-white'
                  }`}
        ...
        <div className="rounded-lg shadow overflow-hidden">
          <div className="p-4">
            ...
            <button className="bg-white border px-2 py-1 text-purple-600">
              5
            </button>
            <button className="bg-white border px-2 py-1 text-purple-600">
              Next &gt;
