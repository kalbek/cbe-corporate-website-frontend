          ...
          <div className="w-1/2 flex items-center justify-center">
            <div className="max-w-2xl px-8 py-6">
              ...
              <p className="max-w-2xl text-base mb-4 text-white !text-white">
                Easily locate the nearest CBE branch or ATM—anytime, anywhere.
                Our locator tool helps you access banking services quickly, no
      ...
      <div className="bg-gray-50">
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <button className="px-6 py-2 bg-[#892890] text-white rounded-lg">
              ATM's
            </button>
            <button className="px-6 py-2 border border-[#892890] text-[#892890] rounded-lg">
              Branches
            </button>
          </div>
