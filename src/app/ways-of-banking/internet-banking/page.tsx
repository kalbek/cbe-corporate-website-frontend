          ...
          <div className="w-1/2 flex items-center justify-center">
            <div className="max-w-2xl px-8 py-6">
              ...
              <p className="max-w-2xl text-base mb-4 text-white !text-white">
                ...
                via the Internet offers almost every service traditionally
                available through a local branch including balance inquiry,
                transfers, Mini Statement, detailed transactions, and online
                bill payments. It provides easy, convenient, flexible and secure
                payment services for CBE customers.
              </p>
              <a
                href="#"
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
              ...
              <div className="md:pl-8">
                <div className="mb-4">
                  <h3 className="text-sm md:text-base text-black">
                    Account Transaction details (viewing, printing,
                    downloading,…){' '}
                  </h3>
                  <div className="border-b border-[#F6A100] w-full"></div>
                </div>
        ...
        <div className="max-w-7xl text-[#892890] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-4">
            <img
              ...
              alt="How to use Internet Banking"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#892890] text-white p-6 rounded-lg">
              ...
              <p>
                Register for internet banking by visiting any CBE branch or
            ...
            <div className="bg-[#892890] text-white p-6 rounded-lg">
              ...
              <p>
                Log in to your internet banking account using your customer ID
                and password.
              </p>
            </div>
            <div className="bg-[#892890] text-white p-6 rounded-lg">
              ...
              <p>
                Set up security questions and answers for additional protection.
              </p>
            </div>
            <div className="bg-[#892890] text-white p-6 rounded-lg">
              <h3 className="text-2xl font-bold mb-4">Step 4</h3>
              <p>
                Start using all the features of internet banking including
                transfers, payments, and account management.
              </p>
            </div>
          </div>
        </div>
